...
$dbname = 'epiz_31429415_AlmendriaBase';
                    ...
                    die("27 Connection failed: " . $conn->connect_error);
                    }
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        die("40 Username and/or password are incorrect.".$_SESSION["username"]);
                    }
                    ...
                    if ($prices != "") {
                        ...
                        // Check connection
                        if ($conn->connect_error) {
                        die("49 Connection failed: ".$conn->connect_error);
                        }
                        ...
                        while ($x < intval($shares)) {
                            $conn = new mysqli($servername, $username, $password, $dbname);
                            if ($conn->connect_error) {
                                die("83 Connection failed: " . $conn->connect_error);
                            }
                        ...
                        while ($x < $shares) {
                            ...
                            $conn = new mysqli($servername, $username, $password, $dbname);
                            if ($conn->connect_error) {
                                die("128 Connection failed: " . $conn->connect_error);
                            }
